...
const MemberForms = props =>{
    ...
    return(
        ...
        <option value='options'>Click to find your character class</option>
        <option value='Warrior'>Become a Warrior and fight to become legendary!</option>
        <option value='Mage'>Become a mage and build thy magic to defeat thy foes!</option>
        <option value='Archer'>Become an Archer and become the best marksmen of all!</option>
        <option value='Knight'>Become a knight and be one of the most gentle fighters  'i  the kingdom!</option>
        <option value='Agent'>Become an agent, thou shall be dog at pretending thou art something thy  not</option>
        </select>
